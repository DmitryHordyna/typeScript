// hw2
{
    ...
    var isLoginValid_1 = function (login) {
        return login.length >= 4 && login.length <= 16;
    };
    var isLoginUnique_1 = function (allLogins, login) {
        return allLogins.includes(login);
    };
    var addLogin = function (allLogins, login) {
        var message;
        message = isLoginValid_1(login) ? "valid" : 'need more letters';
        message = isLoginUnique_1(allLogins, login) ? 'good' : "you have";
        return message;
    };
